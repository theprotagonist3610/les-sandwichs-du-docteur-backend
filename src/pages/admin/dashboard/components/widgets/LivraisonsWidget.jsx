      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="bg-green-50 rounded-lg p-3 text-center">
            ...
            <p className="text-lg font-bold text-green-600">{stats.aLHeure}</p>
            <p className="text-xs text-green-700 font-medium">À l'heure</p>
          </div>
          <div className="bg-red-50 rounded-lg p-3 text-center">
            <div className="flex items-center justify-center mb-1">
              <AlertCircle className="w-4 h-4 text-red-600" />
            </div>
            <p className="text-lg font-bold text-red-600">{stats.enRetard}</p>
        ...
        <div>
          <div className="flex items-center justify-between mb-2">
            <span className="text-sm font-medium text-gray-700">Taux de livraison</span>
            <span className="text-sm font-bold text-green-600">{stats.tauxReussite}%</span>
          </div>
        ...
        <div>
          <h4 className="text-sm font-medium text-gray-700 mb-3">Livraisons en cours</h4>
