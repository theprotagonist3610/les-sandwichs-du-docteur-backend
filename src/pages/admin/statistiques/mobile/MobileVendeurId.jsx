    ...
    <div className="p-4 space-y-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1">
          <h1 className="text-2xl font-bold">{enrichedVendeurStats.nom}</h1>
        ...
        <CardContent>
          {enrichedVendeurStats.articles_vendus.length > 0 ? (
            <div className="space-y-2">
              {enrichedVendeurStats.articles_vendus.slice(0, 10).map((article) => (
                <div
                  key={article.id}
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            {enrichedVendeurStats.evolution.slice().reverse().slice(0, 15).map((day) => (
              <div
                key={day.date}
