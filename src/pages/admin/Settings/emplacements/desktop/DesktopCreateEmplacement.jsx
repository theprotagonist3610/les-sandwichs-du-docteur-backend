...
const DesktopCreateEmplacement = () => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold">Nouvel emplacement</h1>
            ...
            <motion.div
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Sélectionner la catégorie</CardDescription>
                </CardHeader>
            ...
            <motion.div
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Définir les heures d'ouverture hebdomadaires
                  </CardDescription>
                </CardHeader>
...
export default DesktopCreateEmplacement;
