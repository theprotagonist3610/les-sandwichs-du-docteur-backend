...
const MobilePresence = () => {
  ...
  const kpis = useMemo(
    () => ({
      online: usersWithPresence.filter((u) => u.presence.status === "online")
        .length,
      offline: usersWithPresence.filter((u) => u.presence.status === "offline")
        .length,
      away: usersWithPresence.filter((u) => u.presence.status === "away")
        .length,
    }),
    [usersWithPresence]
  );
