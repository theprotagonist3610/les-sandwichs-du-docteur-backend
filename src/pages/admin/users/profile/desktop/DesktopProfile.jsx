...
const DesktopProfile = () => {
  ...
  if (!user) {
    return <div className="p-6"><Card className="border-red-200 bg-red-50"><CardContent className="pt-6"><p className="text-red-600">Utilisateur non trouvé</p><Button onClick={() => navigate("/admin/users/profiles")} className="mt-4">Retour</Button></CardContent></Card></div>;
  }
