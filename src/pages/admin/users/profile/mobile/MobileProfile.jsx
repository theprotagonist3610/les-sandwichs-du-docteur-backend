...
const MobileProfile = () => {
  ...
  if (!user) {
    return <div className="p-4"><Card className="border-red-200 bg-red-50"><CardContent className="pt-6"><p className="text-sm text-red-600">Utilisateur non trouvé</p><Button size="sm" onClick={() => navigate("/admin/users/profiles")} className="mt-4">Retour</Button></CardContent></Card></div>;
  }
    ...
    <div className="pb-20">
      <div className="sticky top-0 z-10 bg-background border-b p-4">
        <div className="flex items-center gap-3 mb-3">
          <Button variant="ghost" size="icon" onClick={() => navigate("/admin/users/profiles")}><ArrowLeft className="h-5 w-5" /></Button>
