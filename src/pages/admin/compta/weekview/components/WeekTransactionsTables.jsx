...
/**
 * 📋 Tableaux des transactions de la semaine
 * 2 tableaux: Entrées et Sorties (ou switch sur desktop)
 */
const WeekTransactionsTables = ({ weekId, weekInfo, activeTable }) => {
  const navigate = useNavigate();
  const { isMobile } = useBreakpoint(1024);
  const { transactions, loading } = useTransactions(weekId);
...
export default WeekTransactionsTables;
