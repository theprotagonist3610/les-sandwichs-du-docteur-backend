/*
cuisinier/userToolkit.jsx
Gestion des accès Firestore et RTDB pour un utilisateur cuisinier

Redirection par défaut : /production
*/
...
export async function createUser(userData, options = { autoLogin: true }) {
  try {
    ...
    return {
      success: true,
      user: userDocData,
      message: "Cuisinier créé avec succès",
    };
  } catch (error) {
...
export async function updateUser(userId, updateData) {
  try {
    ...
    return {
      success: true,
      user: updatedUser,
      message: "Cuisinier mis à jour avec succès",
    };
  } catch (error) {
    throw error;
  }
...
export async function loginUser(
  ...
  try {
    ...
    if (userData.role !== "cuisinier") {
      await firebaseSignOut(auth);
      throw new Error(
        "Accès refusé : ce compte n'est pas un compte cuisinier"
      );
    }
    ...
    return {
      success: true,
      user: userData,
      message: "Connexion cuisinier réussie",
    };
  } catch (error) {
    if (
...
export async function logoutUser(navigate, redirectPath = "/login") {
  try {
    ...
    return {
      success: true,
      message: "Déconnexion cuisinier réussie",
    };
  } catch (error) {
    throw error;
  }
